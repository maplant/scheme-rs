# <picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/logo-dark.png"><img align="left" width="140px" src="docs/images/logo-light.png"></picture> Scheme-rs: Embedded Scheme for the Rust Ecosystem
