     ...
     (let ()
            ...
            (if (= lev 0)
              (syntax ("value" p))
                (quasicons (syntax ("quote" unquote))
                           (quasi (syntax (p)) (- lev 1) "here1"))))
           ((quasiquote p) (quasicons (syntax ("quote" quasiquote))
                                      (quasi (syntax (p)) (+ lev 1) "here2")))
           ((p . q)
            (syntax-case (syntax p) (unquote unquote-splicing)
              ((unquote p ...)
               (if (= lev 0)
                   (quasilist* (syntax (("value" p) ...))
                               (quasi (syntax q) lev "here222"))
                   (quasicons
                    (quasicons (syntax ("quote" unquote))
                               (quasi (syntax (p ...)) (- lev 1) "here3"))
                    (quasi (syntax q) lev "here4"))))
              ((unquote-splicing p ...)
               (if (= lev 0)
                   (quasiappend (syntax (("value" p) ...))
                                (quasi (syntax q) lev "here5"))
                   (quasicons
                    (quasicons (syntax ("quote" unquote-splicing))
                               (quasi (syntax (p ...)) (- lev 1) "here6"))
                    (quasi (syntax q) lev "here7"))))
              (_ (quasicons (quasi (syntax p) lev "here8") (quasi (syntax q) lev "here9")))))
               ...
               (if (= lev 0)
                   ...
                   (quasicons
                    (quasicons
                     ...
                     (quasi (syntax (p ...)) (- lev 1) "here10"))
                    (vquasi (syntax q) lev))))
              (_ (quasicons (quasi (syntax p) lev "here11") (vquasi (syntax q) lev)))))
           (() (syntax ("quote" ())))))
       ...
       (lambda (x)
         (syntax-case x ()
           ...
           ((_ e) (emit (quasi (begin (display "e: ") (display #'e) (newline) (syntax e)) 0 "start")))))))
